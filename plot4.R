...
plot(as.numeric(feb.power.data$Global_active_power),ylab = 'Global Active Power',xaxt = 'n',xlab = '',type = 'n')
...
plot(as.numeric(feb.power.data$Voltage),ylab = 'Voltage',xaxt = 'n',xlab = 'datetime',type = 'n')
axis(1,at = c(0,1440,2880),labels = c('Thu','Fri','Sat'))
lines(as.numeric(feb.power.data$Voltage))

plot(as.numeric(feb.power.data$Global_reactive_power),ylab = 'Global Reactive Power',xaxt = 'n',xlab = 'datetime',type = 'n')
axis(1,at = c(0,1440,2880),labels = c('Thu','Fri','Sat'))
lines(as.numeric(feb.power.data$Global_reactive_power))
